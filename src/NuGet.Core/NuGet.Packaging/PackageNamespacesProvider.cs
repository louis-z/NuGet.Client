...
{
    public class PackageNamespacesProvider
    {
        ...
        public void Remove(IReadOnlyList<PackageSourceNamespacesItem> packageSourceNamespaces)
        {
            ...
            {
                throw new ArgumentException(Strings.ArgumentCannotBeNullOrEmpty, nameof(packageSourceNamespaces));
            }
        ...
        public static IReadOnlyList<TrustedSignerAllowListEntry> GetAllowListEntries(ISettings settings, ILogger logger)
        {
            ...
            var trustedSignersSection = settings.GetSection(ConfigurationConstants.PackageNamespaces);
