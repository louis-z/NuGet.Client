...
namespace NuGet.Configuration.Test
{
    public class NamespaceItemTests
    {
        ...
        [Fact]
        public void NamespaceItemParse_WithoutKey_Throws()
        {
            // Arrange
            var config = @"
<configuration>
    <packageNamespaces>
        <packageSource key=""nuget.org"">
            ...
            ex.Message.Should().Be(string.Format("Unable to parse config file because: Missing required attribute 'key' in element 'namespace'. Path: '{0}'.", Path.Combine(mockBaseDirectory, nugetConfigPath)));
        }
...
<configuration>
    <packageNamespaces>
        ...
        [Fact]
        public void NamespaceItemParse_Update_UpdatesKeyCorrectly()
        {
            // Arrange
            var config = @"
<configuration>
